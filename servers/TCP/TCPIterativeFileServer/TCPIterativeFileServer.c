...
NOTES:
* This is a TCP Iterative File Server for Upload and Download of a file.

@USAGE:
    $ ./TCPIterativeFileServer -p port
     OR
    $ ./TCPIterativeFileServer
*/
...
int main(int argc, char *argv[]){
    ...
    while(1){
        ...
        close(connectedSock);          //close connected socket after servicing the client
    }
}
